...
namespace Flame\Blog\PostModule\Model\Posts;
...
class PostManager extends \Flame\Model\Manager
{
	...
	{
		/** @var $post \Flame\Blog\PostModule\Entity\Posts\Post */
	...
	{
		return new \Flame\Blog\PostModule\Entity\Posts\Post($title, $content);
	}
