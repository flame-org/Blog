...
class ImportPresenter extends BackPresenter
{
	...
	/**
	 * @autowire
	 * @var \Flame\Blog\PostBundle\Components\Imports\WordPress\IWpImportControlFactory
	 */
	protected $wpImportControlFactory;

	/**
	 * @return \Flame\Blog\PostBundle\Components\Imports\WordPress\WpImportControl
	 */
