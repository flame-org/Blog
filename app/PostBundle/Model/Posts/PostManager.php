...
namespace Flame\Blog\PostBundle\Model\Posts;
...
class PostManager extends \Flame\Model\Manager
{
	...
	{
		/** @var $post \Flame\Blog\PostBundle\Entity\Posts\Post */
	...
	{
		return new \Flame\Blog\PostBundle\Entity\Posts\Post($title, $content);
	}
