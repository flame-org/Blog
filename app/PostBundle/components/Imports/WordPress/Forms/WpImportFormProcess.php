...
namespace Flame\Blog\PostBundle\Components\Imports\WordPress\Forms;
...
class WpImportFormProcess extends \Nette\Object
{
	...
	/**
	 * @param \Flame\Blog\PostBundle\Model\Posts\PostManager $postManager
	 */
	public function injectPostManager(\Flame\Blog\PostBundle\Model\Posts\PostManager $postManager)
	{
	...
	/**
	 * @param $data
	 * @return \Flame\Blog\PostBundle\Entity\Posts\Post
	 */
